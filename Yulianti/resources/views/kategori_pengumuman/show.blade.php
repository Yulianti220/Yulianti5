			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="from-group row">
					 ...
					 <label class="col-md-4 col-from-label text-md-left">{!! $KategoriPengumuman->
					 id !!}</label>
					</div>

					<div class="from-group row">
					 <label class="col-md-4 col-from-label text-md-right">Nama</label>
					 <label class="col-md-4 col-from-label text-md-left">{!! $KategoriPengumuman->nama !!}</label>
					</div>

					<div class="from-group row">
					 <label class="col-md-4 col-from-label text-md-right">Users Id</label>
					 <label class="col-md-4 col-from-label text-md-left">{!! $KategoriPengumuman->users_id !!}</label>
					</div>

					<div class="from-group row">
					 <label class="col-md-4 col-from-label text-md-right">Create</label>
					 <label class="col-md-4 col-from-label text-md-left">{!! $KategoriPengumuman->created_at->format('d/m/Y H:i') !!}</label>
					</div>

					<div class="from-group row">
					 <label class="col-md-4 col-from-label text-md-right">Update</label>
					 <label class="col-md-4 col-from-label text-md-left">{!! $KategoriPengumuman->updated_at->format('d/m/Y H:i') !!}</label>
					</div>
